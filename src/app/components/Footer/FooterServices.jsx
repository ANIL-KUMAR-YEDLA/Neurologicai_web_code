...
export default function VerticalContainer() {
  return (
    <div className="w-[119.735px] h-[305.876px] flex flex-col items-start flex-shrink-0 gap-[5px] ml-[100px]">
      {/* Title */}
      <h3 className="text-[#FFF] text-[13px] font-medium font-[Inter] leading-[26px] tracking-[-0.001em] mb-4">
        Services
      </h3>
      ...
      <ul className="space-y-2">  
        <li>
          <Link
            ...
            className="text-[#979797] text-[13px] font-normal font-[Inter] leading-[26px] tracking-[-0.001em] w-[103px] hover:text-white transition"
          >
            Generative-AI
          </Link>
        </li>
        <li>
          <Link
            ...
            className="text-[#979797] text-[13px] font-normal font-[Inter] leading-[18px] tracking-[-0.001em] w-[103px] hover:text-white transition"
          >
